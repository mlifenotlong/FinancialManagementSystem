...
public class WebCrawlerDemo {
    ...
    public static void main(String[] args) {
        ...
        webCrawlerDemo.myPrint("http://logtool.int.refinitiv.com/"+"UK1P-DDNMCIB02A"+"/ThomsonReuters/CIBORG/Engine/Logs/?C=M;O=D","UK1P-DDNMCIB02A.txt");
    }
...
//                                .compile("<a.*?href=[\"\']?((https?://)?/?[^\"\']+)[\"\']?.*?>(.+)</a>");
                        Pattern pattern = Pattern
                                .compile("<a.*?href=[\"\']?((https?://)?/?[^\"\']+)[\"\']?.*?>(.+)</a></td><td class=[\"\']indexcollastmod[\"\']>(2022-[0-9][0-9]-[0-9][0-9])");
